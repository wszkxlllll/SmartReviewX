        ...
        try:
            with open(filename, 'a', newline='', encoding='utf-8') as f:
                ...
                for review in reviews:
                    ...
                    # 验证数据
                    if not self._validate_review_data(review_dict):
        ...
        try:
            with open(filename, 'r', encoding='utf-8') as f:
                ...
                for row in reader:
                    ...
                    total_sentiment_score += float(row['sentiment_score'])
                    total_quality_score += float(row['quality_score'])
                ...
                return {
                    ...
                    "avg_sentiment_score": total_sentiment_score / total_reviews if total_reviews > 0 else 0,
                    "avg_quality_score": total_quality_score / total_reviews if total_reviews > 0 else 0
                }
